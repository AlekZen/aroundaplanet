...
export const metadata = {
  title: 'Manual del Admin | AroundaPlanet',
  description: 'Guía operativa para el equipo administrativo de AroundaPlanet.',
}

export const dynamic = 'force-static'

async function loadManual(): Promise<string> {
  const filePath = path.join(process.cwd(), 'src', 'content', 'manuals', 'manual-admin.md')
...
export default async function AdminManualPage() {
  ...
  return (
    <article className="mx-auto max-w-4xl space-y-2 px-1 pb-12 text-foreground">
      <ReactMarkdown
        ...
        components={{
          ...
          a: ({ href, children }) => (
            <a
              href={href}
              className="text-primary underline decoration-accent decoration-2 underline-offset-2 hover:text-primary-light"
